...
import random
random.seed(0)
from semseg.colormap import random_color, _COLORS
...
class Visualizer:
    ...
    def __init__(self, img_rgb, cat_num, is_seg=True, metadata=None, scale=1.0, instance_mode=ColorMode.IMAGE):
        """
        Args:
    ...
    #     try:
    #         colors = [
    #             self._jitter([x / 255 for x in stuff_colors[c]]) for c in category_ids
    #         ]
    #     except AttributeError:
    #         colors = None

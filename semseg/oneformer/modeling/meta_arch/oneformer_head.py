...
class OneFormerHead(nn.Module):
    ...
    def layers(self, features, tasks, mask=None):
        ...
        print("Mask features:", mask_features.shape)
        print("Transformer encoder features:", transformer_encoder_features.shape)
        for i, feature in enumerate(multi_scale_features):
            print("Multi scale features: ", i, "shape: ", feature.shape)
